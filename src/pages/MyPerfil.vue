...
Max Leandro Silva
  ...
  <q-btn flat round dense icon="account_circle" style="color: #9c27b0;" @click="myContato = !myContato" />
...
<p class="bio">sssasadsfdsfssdgcdsfs daff fsdfsdga fgghga gdfhhah hgshsfhh</p>
   ...
   <!-- -->
    <q-dialog v-model="myContato" seamless position="bottom">
      <q-card style="width: 100%; height: 45vh;">
        <q-card-section class="items-center no-wrap">

    <div class="col-12">
      <div class="fechar-contato " @click="myContato = false">
